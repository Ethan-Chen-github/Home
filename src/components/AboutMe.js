...
import { Typography, Divider, Layout, Timeline, Icon, Collapse } from "antd";
        ...
        <div style={{ textAlign: "center" }}>
          <Typography className="typolog">
            ...
            <Paragraph className="self_intro">
              Hi! My name is Ethan Chen. I Completed Bachelor degrees at Stony
              Brook University. I'm currently a Master Student at Stony Brook
              University .
            </Paragraph>
          </Typography>
        </div>
